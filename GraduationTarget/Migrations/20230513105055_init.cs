    ...
    public partial class init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Стадия проектирования", "Проектирование", null },
                    { 2, "Стадия разработки", "Разработка", null },
                    { 3, "Стадия тестирования", "Тестирование", null },
                    { 4, "Стадия завершения", "Завершение", null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "#008000", "Стадия проекта соответствует срокам", "По плану" },
                    { 2, "#FF8C00", "Есть риск сорвать сроки стадии", "Под угрозой" },
                    { 3, "#FF0000", "Сроки стадии проекта сорваны", "Отстает" }
                });
